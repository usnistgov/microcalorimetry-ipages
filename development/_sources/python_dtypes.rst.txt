Python Data Types
=================
This package uses two base data types to organized configuration objects that can interface
with both the Python API and with a GUI.
...
This facilitates interoperability of analysis and measurement functions with Python
